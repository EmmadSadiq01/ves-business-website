...
<head>
    ...
    <title>VES | Web Development</title>
...
<body>
        ...
        <div class="main">
            ...
            <div class="web-content">
                <div class="web-container container">
                    <div class="row">
                        <div class="col-md-6 hidden-x" data-aos="fade-in">
    ...
    <script>
        ...
        AOS.init({
            ...
            debounceDelay: 50, // thfile:///F:/VES/website/new%20template/ves-website/services/web-developmente delay on debounce used while resizing window (advanced)
